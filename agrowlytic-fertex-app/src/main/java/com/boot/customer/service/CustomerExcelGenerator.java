...
public class CustomerExcelGenerator {
    ...
    private void writeHeader() {
        ...
        sheet = workbook.createSheet("Customer List");
        ...
        createCell(row, 2, "Mobile Number", style);
    ...
    private void write() {
        ...
        font.setFontHeight(12);
        style.setFont(font);
        for (CustomerDTO record : customerDTOList) {
            ...
            createCell(row, columnCount++, record.getLastOrderedDate(), style);
        }
    }
